...
RELEASED_TARBALL = $(topdir)/$(PROJECT_NAME)-$(PROJECT_VERSION).tar.xz
...
help:
	@echo "rpminspect-data-redhat helper Makefile"
	...
	@echo "    env BRANCHES=\"eng-fedora-33 eng-rhel8\" make koji"
